...
- 🔧 **Manual Base URL Management** - `setBaseUrl()` and `getBaseUrl()` for advanced use cases
...
- 🔄 Improved route building with better configuration options
...
- 🪶 More efficient query string building
